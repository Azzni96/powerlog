...
import formsQuestionRoutes from './routes/formsQuestionRoutes';
import formsAnswerRoutes from './routes/formsAnswerRoutes';
import formAnswerRoutes from './routes/formAnswerRoutes';
import userProfileRoutes from './routes/userProfileRoutes';
import workoutFormRoutes from './routes/workoutFormRoutes';
...
app.use('/api/forms-answers', formsAnswerRoutes);
app.use('/api/form-answers', formAnswerRoutes);
